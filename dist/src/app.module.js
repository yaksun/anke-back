...
const trading_log_entity_1 = require("./card/trading_log.entity");
...
const asset_entity_1 = require("./money/asset.entity");
    ...
    common_1.Module({
        imports: [
            typeorm_1.TypeOrmModule.forRoot({
                ...
                password: '123456',
                database: 'cg_back',
                entities: [trading_log_entity_1.TradingLog, images_entity_1.Images, user_entity_1.User, role_entity_1.Role, auth_entity_1.Auth, asset_entity_1.Asset],
                synchronize: true,
                logging: true
            }),
