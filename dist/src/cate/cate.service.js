...
let CateService = class CateService {
    ...
    async delCate(id) {
        return await this.cateRepository.createQueryBuilder().delete().from(cate_entity_1.Cate).where("id=:id", { id: id }).execute();
    }
};
CateService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(cate_entity_1.Cate)),
