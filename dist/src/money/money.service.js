...
let MoneyService = class MoneyService {
    ...
    async delItem(id) {
        return await this.moneyRepository.createQueryBuilder().delete().from(asset_entity_1.Asset).where("id=:id", { id: id }).execute();
    }
};
MoneyService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(asset_entity_1.Asset)),
